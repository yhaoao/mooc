...
class WordTrigger(Trigger):
    ...
    def isWordIn(self,text):
        ...
        for textWord in textList:
            if self.word.lower()==textWord.lower():
                return True
        return False
...
def makeTrigger(triggerMap, triggerType, params, name):
    ...
    if triggerType=='TITLE':
        result=TitleTrigger(params[0])
    elif triggerType=='SUBJECT':
        result=SubjectTrigger(params[0])
    elif triggerType=='SUMMARY':
        result=SummaryTrigger(params[0])
    elif triggerType=='PHRASE':
        result=PhraseTrigger(' '.join(params))
    elif triggerType=='NOT':
        result=NotTrigger(triggerMap[params[0]])
    elif triggerType=='AND':
        result=AndTrigger(triggerMap[params[0]],triggerMap[params[1]])
    elif triggerType=='OR':
        result=OrTrigger(triggerMap[params[0]],triggerMap[params[1]])
